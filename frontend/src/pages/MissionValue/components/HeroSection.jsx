  ...
  return (
    <section className="relative flex items-center justify-center min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          className="absolute bg-blue-500 rounded-full -top-40 -right-40 w-80 h-80 mix-blend-multiply filter blur-xl opacity-70"
          animate={{
            x: [0, 100, 0],
            y: [0, -100, 0],
          }}
        ...
        />
        <motion.div
          className="absolute bg-sky-500 rounded-full -bottom-40 -left-40 w-80 h-80 mix-blend-multiply filter blur-xl opacity-70"
          animate={{
            x: [0, -100, 0],
            y: [0, 100, 0],
          }}
        ...
        />
        <motion.div
          className="absolute bg-indigo-500 rounded-full top-40 left-40 w-80 h-80 mix-blend-multiply filter blur-xl opacity-70"
          animate={{
            x: [0, -50, 0],
            y: [0, 50, 0],
          }}
        ...
        >
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="p-6 text-center border bg-white/10 backdrop-blur-lg rounded-xl border-white/20"
            >
