...
const TemplateGallery = () => {
  ...
  const handleUseTemplate = (templateId) => {
    ...
    console.log("Navigation path:", `${path.create_resume}?template=${templateId}`);

    try {
      navigate(`${path.create_resume}?template=${templateId}`, { replace: true });
    } catch (error) {
      console.error("Navigation error:", error);
      window.location.href = `${path.create_resume}?template=${templateId}`;
    }
  };
