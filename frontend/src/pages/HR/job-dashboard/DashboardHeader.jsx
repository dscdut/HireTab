          ...
          <div className="flex items-center space-x-2 flex-wrap">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-8 pr-3 py-2 w-56 border border-gray-300 rounded-lg bg-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                value={searchQuery}
            ...
            <div className="flex items-center space-x-1">
              ...
              <select
                className="px-2 py-2 border border-gray-300 rounded-lg bg-white text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
