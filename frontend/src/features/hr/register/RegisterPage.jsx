...
const RegisterPage = () => {
  ...
  return (
    <div className="flex min-h-screen bg-white font-outfit">
      {/* Left Side - Visual Testimonial (Same as Login) */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.div
        ...
        className="flex flex-col items-center flex-1 px-6 py-12 lg:px-20 bg-white overflow-y-auto"
      >
        <div className="w-full max-w-md">
          {/* Role Switcher */}
          <div className="flex p-1 mb-10 bg-gray-100 rounded-lg w-fit mx-auto mt-4">
            <button
          ...
          <div className="text-center mb-10">
            <h2 className="text-3xl font-extrabold text-gray-900 mb-2">Get more opportunities</h2>
          </div>

          <button className="flex items-center justify-center w-full py-3.5 px-4 mb-8 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-indigo-700 tracking-tight">Sign Up with Google</span>
            </div>
          </button>
          ...
          <div className="relative mb-8 text-center">
            ...
            <span className="relative z-10 px-4 text-sm font-medium text-gray-400 bg-white">Or sign up with email</span>
          </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-bold text-gray-700">Full name</FormLabel>
                    <FormControl>
                      <Input
                        placeholder="Enter your full name"
                        className="py-6 border-gray-200 rounded-lg focus:ring-indigo-500 shadow-sm"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm font-bold text-gray-700">Confirm</FormLabel>
                      <FormControl>
                        <Input
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-bold text-gray-700">Phone Number</FormLabel>
                    <FormControl>
                      <Input
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm font-bold text-gray-700">Birthday</FormLabel>
                      <FormControl>
                        <Input
                          type="date"
                          className="py-6 border-gray-200 rounded-lg focus:ring-indigo-500 shadow-sm"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm font-bold text-gray-700">Address</FormLabel>
                      <FormControl>
                        <Input
              ...
              <div className="text-center">
                <p className="text-sm font-medium text-gray-500">
                  ...
                  <Link to={path.login} className="font-bold text-indigo-600 hover:underline">
                    Login
                  </Link>
                </p>
              </div>

              <div className="text-[11px] text-gray-400 text-center px-4 leading-relaxed mt-4">
                By clicking 'Continue', you acknowledge that you have read and accept the <Link to="#" className="text-indigo-600 font-semibold">Terms of Service</Link> and <Link to="#" className="text-indigo-600 font-semibold">Privacy Policy</Link>.
              </div>
            </form>
          </Form>
        </div>
