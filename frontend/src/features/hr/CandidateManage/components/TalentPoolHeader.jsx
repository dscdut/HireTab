...
export default function TalentPoolHeader({
  ...
  return (
    <div className="top-0 z-50 bg-white border-b border-gray-200 shadow-sm backdrop-blur-sm">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center space-x-3">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h1 className="text-lg font-semibold text-gray-900">{jobName}</h1>
                <p className="text-xs text-gray-500">{candidatesCount} rejected candidates</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center space-x-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-56 py-2 pl-8 pr-3 text-sm transition-all bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                value={searchQuery}
            ...
            >
              ...
              <span>Filter</span>
              {filtersCount > 0 && (
                <span className="ml-1 px-1.5 py-0.5 bg-purple-500 text-white text-xs rounded-full">{filtersCount}</span>
              )}
            </button>
            ...
            <div className="flex items-center space-x-1">
              ...
              <select
                className="px-2 py-2 text-sm font-medium bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
